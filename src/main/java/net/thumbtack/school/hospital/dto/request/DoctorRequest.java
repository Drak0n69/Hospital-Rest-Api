...
public abstract class DoctorRequest {
    ...
    public DoctorRequest(String dateStart, String dateEnd, int duration, WeekScheduleRequestDto weekSchedule) {
    ...
    public DoctorRequest(String dateStart, String dateEnd, int duration, List<DayScheduleRequestDto> daySchedule) {
        this.dateStart = dateStart;
        this.dateEnd = dateEnd;
        this.duration = duration;
